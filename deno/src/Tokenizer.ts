import decodeCodePoint from './utils/entities/decode_codepoint.ts'
import entityMap from './utils/entities/maps/entities.ts'
import legacyMap from './utils/entities/maps/legacy.ts'
import xmlMap from './utils/entities/maps/xml.ts'
